...
public class ContactServiceApplication extends Application {
    ...
    public ContactServiceApplication() {
        ...
        beanConfig.setTitle("Alex Rantos - Taxi");
        beanConfig.setDescription("CSC8104 Middleware Implementation");

        beanConfig.setResourcePackage(//"org.jboss.quickstarts.wfk.contact,"
                        "org.jboss.quickstarts.wfk.customer,"
                      + "org.jboss.quickstarts.wfk.taxi,"
                      + "org.jboss.quickstarts.wfk.booking,"
                      + "org.jboss.quickstarts.wfk.guestbooking,"
                      + "org.jboss.quickstarts.wfk.travelagent"
        );
